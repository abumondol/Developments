...
public class SharedPrefUtil {
    ...
    public static String getSharedPref(String key, Context context) {
        SharedPreferences pref = context.getSharedPreferences(
                MyConstants.SHARED_PREF_TEMP, Context.MODE_PRIVATE);
    ...
    public static float getSharedPrefFloatStored(String key, Context context) {
        SharedPreferences pref = context.getSharedPreferences(
                MyConstants.SHARED_PREF_STORED, Context.MODE_PRIVATE);
        return pref.getFloat(key, 0);
    }

    public static void putSharedPrefFloatStored(String key, float value, Context context) {
        SharedPreferences pref = context.getSharedPreferences(
                MyConstants.SHARED_PREF_STORED, Context.MODE_PRIVATE);
