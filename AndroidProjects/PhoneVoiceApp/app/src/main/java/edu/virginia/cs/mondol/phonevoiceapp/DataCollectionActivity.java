...
import edu.virginia.cs.mondol.phonevoiceapp.utils.FileUtil;
import edu.virginia.cs.mondol.phonevoiceapp.utils.MC;
import edu.virginia.cs.mondol.phonevoiceapp.utils.SharedPrefUtil;

public class DataCollectionActivity extends AppCompatActivity implements TextToSpeech.OnInitListener, RecognitionListener {
