...
public class FileUtil {
    ...
    public static int fileCount() {
        String folderName = Environment.getExternalStorageDirectory() + "/airsign/data";
    ...
    public static boolean isConfigAvailable() {
        String folderName = Environment.getExternalStorageDirectory() + "/airsign/config";
        File file = new File(folderName);
        if (file.exists() == false) {
            file.mkdir();
        }
    ...
    public static boolean deleteConfig() {
        String filePath = Environment.getExternalStorageDirectory() + "/airsign/config/config.txt";
        File file = new File(filePath);
        return file.delete();
    }
