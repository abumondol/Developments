    ...
    for sess = 1:sess_count
        ...
        for pos = 1:pos_count         
            ...
            for ico_number = 1:ico_count
                ...
                opp_cell_assignment(sub).session(sess).position(pos).ico(ico_number).cell_assignment = cell_assignment;
                %opp_cell_assignment(sub).session(sess).position(pos).ico(ico_number).cell_sequence = cell_seq;
            end            
        end
    end
end

save('opp_cell_assignment', 'opp_cell_assignment');
