function [handle,output] = benchmark_wardbars(label,data)
...
for iSubj=1:nSubj
    ...
    barlegend= {'TP';'Overfill';'Underfill';'Merge';'Insertion';'Fragmentation';'Deletion';'Substitution'};
    barlegendshort = {'S';'D';'F';'I';'M';'U';'O';'TP'};
    explode =[1 1 1 1 1 0 0 0 0];
...
%         end
    ...
    placebars
    bar(placebars,Mscaled(:,1:7),.8,'stacked'), colormap(errorcolors);
...
%         text(xpos,T(1)*(1+0.04), infoLabel );
    ...
    legend(barlegend(end:-1:1),'Location','northoutside','Orientation','horizontal');
