...
phone = 1;
if phone ==1
    d = csvread(strcat(srcFolder,'walk_lg.csv'));
else
    d = csvread(strcat(srcFolder,'walk_nexus.csv'));
end 
...
b = b(b(:,2)>120, :); % for lg phone extended figure
log(1,2) = 120;
b(:, 2) = b(:, 2) - 120;
log(:, 2) = log(:, 2) - 120;
...
if phone == 1 
    legend('LG-B13', 'LG-B14', 'LG-B15', 'LGCount-B13', 'LGCount-B14', 'LGCount-B15');
else
