...
public class MyFileUtils {
    ...
    public static int[] readLabels(String filePath) throws Exception {
    ...
    public static void writeToCSVFile(String file_name, double[][] data, String header) throws Exception {
        StringBuilder sb = new StringBuilder();
        if (header != null) {
            sb.append(header + "\n");
        }
